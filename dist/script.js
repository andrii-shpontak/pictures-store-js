...
/* harmony import */ var _modules_filte__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/filte */ "./src/js/modules/filte.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'hirizontal', '.main-prev-btn', '.main-next-btn');
  ...
  Object(_modules_filte__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSelecrot, burgerSelector) {
  var menuElem = document.querySelector(menuSelecrot),
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Please choise a size and material";
...
var filter = function filter() {
  ...
  var buttons = function buttons(btn, selector) {
    btn.addEventListener('click', function () {
      typeFilter(selector);
    });
  };
...
var forms = function forms(state) {
  ...
  var message = {
    loading: 'Loading...',
    success: 'Thank you ! We will call baack you soon',
    failure: 'Something went wfong...',
